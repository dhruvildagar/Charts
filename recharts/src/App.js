import { Line,LineChart,ResponsiveContainer,XAxis,YAxis,CartesianGrid,Legend,Tooltip,Area,AreaChart,Bar,BarChart} from "recharts"
import './App.css';
  ...
  return (
    <div className="App">
     ...
     <ResponsiveContainer width="100%" aspect={3} >
      <LineChart data={pdata} width={500} height={300} margin={{ top: 5, right: 300, left: 100, bottom: 5 }}>
        <CartesianGrid strokeDasharray="3 3"/>
        <XAxis dataKey="name" interval={"preserveStartEnd"} tickFormatter={(value)=>value+"programming"}/>
        <YAxis/>
        <Tooltip contentStyle={{backgroundColor:"pink "}} itemStyle={{backgroundColor:"blue"}}/>
        <Legend/>
